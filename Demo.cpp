...
void Demo::BuildColoredCube() {
	...
	float vertices[] = {
		...
		-1, -1, -0.7, 0, 0,			// 10
		-0.7, -1, -0.7, 0.15, 0,	// 11
		-0.7,  0.7, -0.7, 0.15, 1,  // 12
		-1,  0.7, -0.7, 0, 1,		// 13
		0.7, -1, -0.7, 0.85, 0,		// 14
		1, -1, -0.7, 1, 0,			// 15
		1,  0.7, -0.7, 1, 1,		// 16
		0.7,  0.7, -0.7, 0.85, 1,	// 17
		...
		-0.7, -1, 1, 0, 0,			// 28
		-0.7, -1, 0.7, 0.15, 0,		// 29
		-0.7,  0.7, 0.7, 0.15, 1,	// 30
		-0.7,  0.7, 1, 0, 1,		// 31
		-0.7, -1, -0.7, 0.85, 0,	// 32
		-0.7, -1, -1, 1, 0,			// 33
		-0.7,  0.7, -1, 1, 1,		// 34
		-0.7,  0.7, -0.7, 0.85, 1,	// 35
		...
		1, -1, 0.7, 0, 0,			// 46
		0.7, -1, 0.7, 0.15, 0,		// 47
		0.7,  0.7, 0.7, 0.15, 1,	// 48
		1,  0.7, 0.7, 0, 1,			// 49
		-0.7, -1, 0.7, 0.85, 0,		// 50
		-1, -1, 0.7, 1, 0,			// 51
		-1,  0.7, 0.7, 1, 1,		// 52
		-0.7,  0.7, 0.7, 0.85, 1,	// 53
		...
		0.7, -1, -1, 0, 0,			// 64
		0.7, -1, -0.7, 0.15, 0,		// 65
		0.7,  0.7, -0.7, 0.15, 1,	// 66
		0.7,  0.7, -1, 0, 1,		// 67
		0.7, -1, 0.7, 0.85, 0,		// 68
		0.7, -1, 1, 1, 0,			// 69
		0.7,  0.7, 1, 1, 1,			// 70
		0.7,  0.7, 0.7, 0.85, 1,	// 71
